...
class DBCommunication {
     ...
     * @returns error or success
     */
    transactionOnDb(transacao: { ApostadorID: any; Valor: any; Tipo: any; DataTr?: any; }){
        return new Promise((resolve,reject)=>{
     ...
     * @returns error or success
     */
    registerEventOnDb(eventos: string | any[]){
     ...
     */
    insert_aposta(aposta: any,eventos: string | any[]){
        return new Promise((resolve,reject)=>{
     ...
     * @returns success or error
     */
    registerBetOnDb(aposta: { ApostadorID: any; Montante: any; DateAp: any; },eventos: string | any[],codigo: any){
     ...
     * @returns success or error
     */
    editProfileOnDb(list: any,email: any){
        return new Promise((resolve,reject)=>{
     ...
     */
    setEstadoEvento(estado: string,eventID: any,desporto: any,resultado?: any,descricao?: any){
        return new Promise((resolve,reject)=>{
            let sql
            let args
            if(estado=='FIN'){
     ...
     * @returns success or error
     */
    closeEventOnDb(eventID: any,desporto: any){
        return new Promise((resolve,reject)=>{
            let toNotify:any[]=[]
     ...
     * @returns success or error
     */
    finEventOnDb(eventID: any,desporto: any,resultado: any,descricao: any){
     ...
     */
    usedCodOnDb(email: any,codigo: null){
        return new Promise((resolve,reject)=>{
            if(codigo==null){
