...
const evLst:IEventList = EventList.getInstance(); 
 ...
 export function parseFutResp(json:any){
  ...
  * @param {JSON} json Json that contains the response from the API
  */
 export function parseFutResultResp(json:any){
     if (json.errors.length != 0) {
         console.error("Errors found in json response");
         console.log(json.errors)
         return false;
  ...
  */
 export function parsePTFutResp(json:any){
  ...
  */
 export function parsePTFutResultResp(json:any,games:any){
  ...
  */
 export function parseF1Resp(racesJson:any, pilotsJson:any){
     let pilotsNames = [];
     let pilotsPhotos = [];
  ...
  */
 export function parseF1ResultResp(json:any){
     if (json.errors.length != 0) {
         console.error("Errors found in json response");
         console.log(json.errors)
         return false;
  ...
  */
 export function parseNBAResp(nbaJson:any){
  ...
  */
 export function parseNBAResultResp(json:any){
     if (json.errors.length != 0) {
         console.error("Errors found in json response");
         console.log(json.errors)
         return false;
